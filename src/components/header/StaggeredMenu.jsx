...
export const StaggeredMenu = ({
  ...
  const prefGroupRef = useRef(null);
  ...
  React.useEffect(() => {
    ...
    const handleClickOutside = (event) => {
      if (
        ...
        prefGroupRef.current &&
        !prefGroupRef.current.contains(event.target)
      ) {
        closeMenu();
      }
    };
  ...
  return (
    ...
    >
      ...
      <div className="staggered-menu-header header-blur">
        <br />
        <br />
      </div>
      <header
        className={`staggered-menu-header ${open ? "is-open" : ""}`}
      ...
      >
        ...
        <div className="sm-logo">
          <img
            ...
            draggable={false}
          />
          <span className="sm-logo-text">Justina Rey</span>
        </div>

        <div className="sm-header-actions">
          <div ref={prefGroupRef} className="sm-pref-group">
            <button
            ...
            >
              <img
                ...
                alt={theme === "dark" ? "Tema claro" : "Tema oscuro"}
            ...
            {items && items.length ? (
              ...
              <li className="sm-panel-itemWrap" aria-hidden="true">
                <span className="sm-panel-item">
                  <span className="sm-panel-itemLabel">{t("noItems")}</span>
                </span>
              </li>
            )}
          </ul>
